...
static const u8 sText_PkmnShookOffParalysis[] = _("{B_ATK_NAME_WITH_PREFIX} shook\noff its paralysis!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNSHOOKOFFPARALYSIS - BATTLESTRINGS_TABLE_START] = sText_PkmnShookOffParalysis,
