...
static const union AnimCmd sAnim_URSHIFU_RAPID_STRIKE_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
static const union AnimCmd *const sAnims_URSHIFU_RAPID_STRIKE_GMAX[] ={
    sAnim_GeneralFrame0,
    sAnim_URSHIFU_RAPID_STRIKE_GMAX_1,
};
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    ANIM_CMD(URSHIFU_RAPID_STRIKE_GMAX),
    ANIM_CMD(EGG),
};
