...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_URSHIFU_RAPID_STRIKE_GMAX] = gMonIcon_UrshifuRapidStrikeGmax,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_VENUSAUR_GMAX] = 0, // TODO
    [SPECIES_CHARIZARD_GMAX] = 0,
    [SPECIES_BLASTOISE_GMAX] = 0,
    [SPECIES_BUTTERFREE_GMAX] = 0,
    [SPECIES_PIKACHU_GMAX] = 0,
    [SPECIES_MEOWTH_GMAX] = 0,
    [SPECIES_MACHAMP_GMAX] = 0,
    [SPECIES_GENGAR_GMAX] = 0,
    [SPECIES_KINGLER_GMAX] = 0,
    [SPECIES_LAPRAS_GMAX] = 0,
    [SPECIES_EEVEE_GMAX] = 0,
    [SPECIES_SNORLAX_GMAX] = 0,
    [SPECIES_GARBODOR_GMAX] = 0,
    [SPECIES_MELMETAL_GMAX] = 0,
    [SPECIES_RILLABOOM_GMAX] = 0,
