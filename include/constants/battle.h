...
#define STATUS1_PARALYSIS            (1 << 6 | 1 << 7 | 1 << 8)
#define STATUS1_PARALYSIS_TURN(num)  ((num) << 6)
#define STATUS1_TOXIC_POISON         (1 << 9)
#define STATUS1_TOXIC_COUNTER        (1 << 10 | 1 << 11 | 1 << 12 | 1 << 13)
#define STATUS1_TOXIC_TURN(num)      ((num) << 10)
